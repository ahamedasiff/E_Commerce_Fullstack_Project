    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex flex-col sm:flex-row gap-12 sm:gap-12'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
          <div className='flex sm:flex-col overflow-x-auto sm:overflow-x-scroll 
        ...
        <div className='flex-1'>
          ...
          <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
              ...
              <p>Cash on Deliver Available on this Product</p>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>deghsdfhjsdfihlsdhfklajkh asegahgj hashakjsdhg jahsgk jhaskjdhgakjshdgkjahskjdghdaskjgh kjgh askhdgjkasdhg kjashdgkjsh </p>
          <p>sjdfhsjkd jgsjdfghf sdhgf shdgfhsdg fgshfghgdhs fshfg shdgfhsdg jhg gs  gshgfhdgfs hg</p>
        </div>
      </div>
