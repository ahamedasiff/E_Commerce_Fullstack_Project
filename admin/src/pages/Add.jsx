  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=> setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Product Type' required />
      </div>
      <div className='w-full'>
            ...
            <div key={size} onClick={() => {
              setSizes(prev => 
                prev.includes(size) 
                  ...
                  : [...prev, size]  // <-- include the size here
              )
            }}>
